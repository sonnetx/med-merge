...
Within each dataset, the best-performing merging method varies. Fisher-weighted merging wins ISIC, DARE-TIES wins both radiology datasets (CheXpert and NIH), and PCB-Merging wins lung histopathology (TCGA). 
